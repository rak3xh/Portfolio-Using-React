...
import bot from "../../Assets/Projects/10.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={bot}
              isBlog={false}
              title="Discord Bot by rak3xh"
              description="Discord bot made using C# and .NET. This bot add fun to your discord server by giving un-orthodox meaning of words which are in the english dictionary."
              ghLink="https://github.com/rak3xh/DiscordBot-by-rak3xh"
              demoLink="https://rak3xh.github.io/DiscordBot-by-rak3xh/"
            />
          </Col>
